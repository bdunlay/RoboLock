...
#ifndef __ROBOLOCK_APP_H__
#define __ROBOLOCK_APP_H__
...
typedef struct robolock_app_state {
  struct psock p;
  char inputbuffer[10];
  char name[40];
} uip_tcp_appstate_t;
...
void robolock_app_appcall(void);
#ifndef UIP_APPCALL
#define UIP_APPCALL robolock_app_appcall
#endif /* UIP_APPCALL */

void robolock_app_init(void);

#endif /* __robolock_app_H__ */
/** @} */
/** @} */
