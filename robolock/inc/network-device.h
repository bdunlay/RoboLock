...
#include "type.h" // for custom typedefs
#include "irq.h"
...
/* Standard PHY registers, among all the PHY available, all
...
extern void EMACHandler( void ) __irq;
